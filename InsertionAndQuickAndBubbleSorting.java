...
public class InsertionAndQuickAndBubbleSorting {
	private SortingInformation sortInfo;
	
	public InsertionAndQuickAndBubbleSorting() {
	...
	public static void main(String[] args) {
		...
		InsertionAndQuickAndBubbleSorting insertionQuickBubble_Sorting 
				= new InsertionAndQuickAndBubbleSorting();
	...
	private void showProgrammerInformation() {
		System.out.println("[ ID: 1131410 ]");
		System.out.println("[ Name: Jung In Koh ]");
	}
	...
	public int[] quickSort(int[] integersForSort, int lowIndex, int highIndex) {
		...
		int pivot = integersForSort[lowIndex + (highIndex - lowIndex) / 2];
